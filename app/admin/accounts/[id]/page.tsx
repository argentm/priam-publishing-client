      ...
      <div className="mt-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Navigate to admin management pages</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <Button asChild variant="outline">
                <Link href={ROUTES.ADMIN_WORKS} className="flex items-center gap-2">
                  <FileText className="w-4 h-4" />
                  Manage Works
                </Link>
              </Button>
              <Button asChild variant="outline">
                <Link href={ROUTES.ADMIN_TRACKS} className="flex items-center gap-2">
                  <Music className="w-4 h-4" />
                  Manage Tracks
                </Link>
              </Button>
              <Button asChild variant="outline">
                <Link href={ROUTES.ADMIN_CONTRACTS} className="flex items-center gap-2">
                  <FileSignature className="w-4 h-4" />
                  Manage Contracts
                </Link>
              </Button>
